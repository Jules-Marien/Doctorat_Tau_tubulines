...
np.savetxt('Heatmap_complete_Tau_complexe_modele'+modele+'.txt', matrix_heatmap)
...
plt.title('Pourcentage de contacts observés entre résidus du fragment Tau \n et ceux du complexe de tubuline du modele '+modele+' sur la durée de la trajectoire', fontsize=13,weight='bold')

plt.colorbar().set_label(label='% de contacts observés',fontsize=13,weight='bold')
...
plt.xlabel('Résidus du complexe de tubulines')
...
plt.savefig('Heatmap_contacts_Tau_tubulines_completes_modele'+modele+'.png')
...
plt.title('Contacts observés entre résidus du fragment Tau \n et ceux du complexe de tubuline du modele '+modele+' sur la durée de la trajectoire', fontsize=13,weight='bold')

plt.colorbar().set_label(label='contacts observés',fontsize=13,weight='bold')
...
plt.savefig('Heatmap_binaire_contacts_Tau_tubulines_completes_modele'+modele+'.png')
...
plt.title('Pourcentage de contacts observés entre résidus en contact du fragment Tau \n et ceux du complexe de tubuline du modele '+modele+' sur la durée de la trajectoire', fontsize=13,weight='bold')
...
plt.xlabel('Résidus du complexe de tubulines en contact avec le fragment Tau')
plt.ylabel('Résidus du fragment Tau')
...
plt.savefig('Heatmap_reduite_contacts_Tau_tubulines_modele'+modele+'.png')
