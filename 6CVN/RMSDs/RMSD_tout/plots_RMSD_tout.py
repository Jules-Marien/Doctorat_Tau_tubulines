...
RMSD_alpha1_beta1_avec_tau_modele17 = np.genfromtxt('../data/alpha1_beta1_avec_tau/RSMDs_alpha1_beta1_avec_tau_modele17.txt')[:,1]
RMSD_alpha1_beta1_avec_tau_modele22 = np.genfromtxt('../data/alpha1_beta1_avec_tau/RSMDs_alpha1_beta1_avec_tau_modele22.txt')[:,1]
RMSD_alpha1_beta1_avec_tau_modele84 = np.genfromtxt('../data/alpha1_beta1_avec_tau/RSMDs_alpha1_beta1_avec_tau_modele84.txt')[:,1]



#alpha1_beta1_sans_tau

RMSD_alpha1_beta1_sans_tau_modele17 = np.genfromtxt('../data/alpha1_beta1_sans_tau/RSMDs_alpha1_beta1_sans_tau_modele17.txt')[:,1]
RMSD_alpha1_beta1_sans_tau_modele22 = np.genfromtxt('../data/alpha1_beta1_sans_tau/RSMDs_alpha1_beta1_sans_tau_modele22.txt')[:,1]
RMSD_alpha1_beta1_sans_tau_modele84 = np.genfromtxt('../data/alpha1_beta1_sans_tau/RSMDs_alpha1_beta1_sans_tau_modele84.txt')[:,1]



#a1_b3_avec_tau

RMSD_a1_b3_avec_tau_modele16 = np.genfromtxt('../data/a1_b3_avec_tau/RSMDs_a1_b3_avec_tau_modele16.txt')[:,1]
RMSD_a1_b3_avec_tau_modele38 = np.genfromtxt('../data/a1_b3_avec_tau/RSMDs_a1_b3_avec_tau_modele38.txt')[:,1]
RMSD_a1_b3_avec_tau_modele65 = np.genfromtxt('../data/a1_b3_avec_tau/RSMDs_a1_b3_avec_tau_modele65.txt')[:,1]



#a1_b3_sans_tau

RMSD_a1_b3_sans_tau_modele16 = np.genfromtxt('../data/a1_b3_sans_tau/RSMDs_a1_b3_sans_tau_modele16.txt')[:,1]
RMSD_a1_b3_sans_tau_modele38 = np.genfromtxt('../data/a1_b3_sans_tau/RSMDs_a1_b3_sans_tau_modele38.txt')[:,1]
RMSD_a1_b3_sans_tau_modele65 = np.genfromtxt('../data/a1_b3_sans_tau/RSMDs_a1_b3_sans_tau_modele65.txt')[:,1]



#sans_CTT

RMSD_sans_CTT_modele17 = np.genfromtxt('../data/modeles_sans_CTT/RSMDs_modele17_sans_CTT.txt')[:,1]
RMSD_sans_CTT_modele22 = np.genfromtxt('../data/modeles_sans_CTT/RSMDs_modele22_sans_CTT.txt')[:,1]
RMSD_sans_CTT_modele84 = np.genfromtxt('../data/modeles_sans_CTT/RSMDs_modele84_sans_CTT.txt')[:,1]
...
plt.savefig('RMSD_tout_beta1_avec_tau.png')
...
plt.savefig('RMSD_tout_b3_avec_tau.png')
...
plt.savefig('RMSD_tout_sans_CTT.png')
...
with open('Valeurs_moyennes_RMSD_tout.txt','w') as outputfile:
     outputfile.write("Mean values of RMSD on backbone for the whole proteic complex" + "\n")
